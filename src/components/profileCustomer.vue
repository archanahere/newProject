<template>
    <div class="container row-4 bg-blue-200">
      <form class="row g-5">
  <div class="col-md-3">
  ...
  <div class="col-12">
    <div class="form-check">
      <input class="form-check-input m-3 " type="checkbox" id="gridCheck">
      <label class="form-check-label m-2 p-3" for="gridCheck">
        Check me out
      </label>
    </div>
    </div>
