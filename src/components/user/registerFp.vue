<template>
  <div class="row">
    <!-- <div class="col"> -->
    <div
      class="box col-sm-3 col-md-6 d-flex justify-content-center align-items-center"
      style="height: 100vh"
    >
      <figure class="">
        <img
...
export default {
  ...
  methods: {
    async next() {
      ...
      // this.$v.$touch();
      // validate :{
      // if (!this.$v.$pending || this.$v.$errorMessage) {
      ...
      //  await axios.post("http://localhost:3000/user-info", {
